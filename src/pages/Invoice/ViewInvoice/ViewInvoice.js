                        ...
                        <Row>
                          <Col className="title-invoice" span={24}>
                            ...
                            <p style={style}>
                              ...
                              {data &&
                                data.ngayDauKy &&
                                dayjs(data.ngayDauKy).format("DD-MM-YYYY")}
                            </p>
                            <p style={style}>
                              đến ngày{" "}
                              {data &&
                                data.ngayCuoiKy &&
                                dayjs(data.ngayCuoiKy).format("DD-MM-YYYY")}
                            </p>
                          </Col>
                        </Row>
                        <Row>
                          <Col span={24} className="customer-info">
                                ...
                                <table className="table-invoice">
                                  ...
                                  <td style={style} colSpan={1}>
                                    ...
                                    data?.giaPhiDuyTri === 0 ? (
                                      ...
                                      <tr className="total">
                                        <td style={style} colSpan={2}>
                                          <b> % VAT phí duy trì</b>
                                        </td>
                                        <td style={style} colSpan={1}>
                                         <b> {data?.phanTramVATPhiDuyTri}%
                                          </b>
                                        </td>
                                      </tr>
                                      </>
                                    ...
                                    data?.giaPhiDuyTri === 0 ? (
                                      <tr className="total">
                                        ...
                                        {data?.tongTienTruocVat && (
                                          <td style={style} colSpan={1}>
                                            <b>{data.vat?.toLocaleString("en-US")}</b>
                                          </td>
                                        )}
                                      </tr>
                                    ) : (
                                    ...
                                    data?.giaPhiDuyTri === 0 ? (
                                      <tr className="total">
                                        ...
                                        {data?.tongTienHoaDon && (
                                          <td style={style} colSpan={1}>
                                          <b> {data.tongTienHoaDon?.toLocaleString(
                                              "en-US"
                                            )}</b> 
                                          </td>
                                        )}
                            ...
                            <Row>
                              ...
                              <b style={style}>
  Bằng chữ:{" "}
  {data?.giaPhiDuyTri === null || data?.giaPhiDuyTri === 0
    ? convertToWords(
        Math.round(
          data?.tongTienPhiDuyTriSauVAT !== null
            ? data?.tongTienPhiDuyTriSauVAT
            : data?.tongTienHoaDon
        )
      )
                      ...
                      <Col span={12}>
                        ...
                        <Row>
                          <Col span={24} className="customer-info">
                            ...
                            <p style={style}>
                              Đơn vị bán hàng: <b>{data2?.phanLoaiNhaMay}</b>
                            </p>
                            <p style={style}>
                              Địa chỉ:{" "}
                              <span style={{ fontWeight: "bold" }}>
                            ...
                            <p style={style}>
                              ...
                              <span style={{ fontWeight: "bold" }}>
                                {" "}
                                {data2?.taiKhoanNganHang} - {data2?.tenNganHang}
                              </span>
                            </p>
                            <p style={style}>
                              Chủ tài khoản: <b>{data2?.chuTaiKhoanNganHang}</b>
                            </p>
                            <p style={style}>
                              <b> {data?.tenNhaMay} </b>{" "}
                            </p>
                                ...
                                <tr className="sign">
                                  ...
                                  >
                                    <div style={{ textAlign: "center" }}>
                                      <img
                                        src={`${process.env.REACT_APP_IMAGE}${data?.imageChuKy}`}
                                        alt="Ảnh chữ ký"
                                        style={{
                                          width: "152px",
                                          height: "80px",
                                ...
                                data?.giaPhiDuyTri === 0 ? (
                                  ...
                                  {data?.giaPhiDuyTri && (
                                    <td colSpan={1} style={style}>
                                      <b>
                                        {Math.floor(
                                          data?.tongTienPhiDuyTriSauVAT !== null ? data?.tongTienPhiDuyTriSauVAT : data?.tongTienHoaDon
                                        )?.toLocaleString("en-US")}
                                      </b>
                                    </td>
                                  )}
